from exploratory_data_analysis.anamoly_detector import GenericAnomalyDetector
...
def main():
    ...
    # Step 2: Select which columns to run anomaly detection on
    detector.set_anomaly_columns(["cost_per_kg", "energy_per_kg"])

    # Step 3: Detect anomalies using class methods
